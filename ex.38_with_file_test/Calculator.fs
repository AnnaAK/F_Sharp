...
let main argv =
  ...
  let pathRead = @"D:\Мои документы\proj\Visual Studio\ConsoleApplication1\hw05_03\MyTest.txt" 
  ...
  let pathWrite = @"D:\Мои документы\proj\Visual Studio\ConsoleApplication1\hw05_03\Result.txt"
